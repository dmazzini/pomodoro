...
Aplicación de escritorio GTK/Python para la técnica Pomodoro con seguimiento de tareas.

## Agent skills

### Issue tracker

Issues live as GitHub issues at `dmazzini/pomodoro`, managed with the `gh` CLI. See `docs/agents/issue-tracker.md`.
